...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.94.0 (4a4ef493e 2026-03-02) (Arch Linux rust 1:1.94.0-2)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.94.0 (4a4ef493e 2026-03-02) (Arch Linux rust 1:1.94.0-2)";
#[allow(clippy::needless_raw_string_hashes)]
